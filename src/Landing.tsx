    ...
    <div className="landing-page">
      ...
      <main>
          ...
          <div className="landing-visual" aria-label="StockPass portfolio proof preview">
            <div className="proof-window">
              ...
              <div className="proof-chart">
                ...
                <div className="chart-bubble"><b>LIVE</b><span>official market feed</span></div>
              </div>
              <div className="position-listing">
                <div><span className="asset-avatar nvda">NV</span><div><b>NVDAx</b><small>Official xStocks registry</small></div><strong>—</strong><em>verified onchain</em></div>
                <div><span className="asset-avatar aapl">AP</span><div><b>AAPLx</b><small>Official xStocks registry</small></div><strong>—</strong><em>verified onchain</em></div>
                <div><span className="asset-avatar spy">SP</span><div><b>SPYx</b><small>Official xStocks registry</small></div><strong>—</strong><em>verified onchain</em></div>
              </div>
            ...
            <div className="float-card float-card-bottom"><span className="float-label">SOCIAL SIGNAL</span><b>Verified activity from people you follow</b><div className="signal-people"><span>ON</span><span>SP</span><span>XM</span><i>LIVE</i></div></div>
          </div>
        </section>
        ...
        <section className="landing-story" id="proof">
          ...
          <div className="story-body"><p>StockPass connects the social layer to the wallet layer. When you publish about an asset, the app checks the connected wallet against the official asset mint and stores the verification moment.</p><p className="story-note">The claim is about what the wallet held when the post was created — not what someone says they held.</p></div>
        </section>
